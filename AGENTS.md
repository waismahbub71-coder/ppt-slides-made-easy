# ppt-slides-made-easy

PPT Slides Made Easy — a tool for coaches, teachers, and executives to generate quality presentation content with clean themes, edit slides inline, and export a printable preview — fast.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296504607+waismahbub71-coder@users.noreply.github.com"
  git config user.name "waismahbub71-coder"
  ```
